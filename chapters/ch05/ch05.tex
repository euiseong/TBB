...
\begin{tbbitemize}
  ...
  \item Diagnose the six canonical pod failure states — Pending, ImagePullBackOff, CrashLoopBackOff, OOMKilled, Evicted, and Running-but-unrouted — from their signatures, with the right first command for each.
\end{tbbitemize}
\end{calloutbox}
